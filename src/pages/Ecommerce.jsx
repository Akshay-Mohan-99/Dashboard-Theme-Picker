    ...
    <div className='mt-12'>
      <div className='flex flex-wrap lg:flex-nowrap
        justify-center'>
          <div className='bg-white dark:text-gray-200 
            ...
            lg:w-80 pd-8 pt-9 m-3 bg-cover bg-center bg-hero-pattern'>
              <div className='flex justify-between items-center'>
                <div>
                  <p className='font-bold text-gray-400'>Earnings</p>
                  <p className='text-2xl'>$1,00,000</p>
                </div>
              </div>
              <div className='mt-6'>
                <Button 
                ...
                gap-1 items-center'>
                  {earningData.map((item) => (
                    <div key={item.title} className='bg-white 
                      dark:bg-secondary-dark-bg dark:text-white md:w-56 p-4 pt-9 rounded-2xl'>
                        <button type='button' style={{ 
                          color : item.iconColor, 
                          backgroundColor : item.iconBg}}
                          className='text-2xl rounded-full 
                            hover:drop-shadow-xl p-4 opacity-0.9'>
                            {item.icon}
                        </button>
                        <p className='mt-3'>
      ...
      <div>
        <div className='bg-white dark:bg-secondary-dark-bg
          m-3 rounded-2xl md:w-780 p-4 dark:text-gray-200'>
                    ...
                    <div>
                      <p>
                        ...
                        <span className='p-1.5 hover:drop-shadow-xl
                          cursor-pointer rounded-full bg-green-400
                          ml-3 text-xs'>50%</span>
                      </p>
